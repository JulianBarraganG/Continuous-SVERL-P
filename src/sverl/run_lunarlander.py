...
for i in trange(NUM_ROUNDS): 
    shapley_pos += shapley.shapley_value(policy.sample_action, nc, shapley.global_sverl_value_function, [0, 1], i, env)
    shapley_vel += shapley.shapley_value(policy.sample_action, nc, shapley.global_sverl_value_function, [2, 3], i, env)
    shapley_angle += shapley.shapley_value(policy.sample_action, nc, shapley.global_sverl_value_function, [4], i, env)
    shapley_angle_vel += shapley.shapley_value(policy.sample_action, nc, shapley.global_sverl_value_function, [5], i, env)
    shapley_leg_bools += shapley.shapley_value(policy.sample_action, nc, shapley.global_sverl_value_function, [6, 7], i, env)
